...
const ADMIN_NAV = [
  ...
  { to: '/admin/masters', label: 'Masters',             icon: Settings },
];
...
export default function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-brand-50/40 overflow-hidden font-sans">
        ...
        <div className="flex items-center gap-3 px-5 py-6 border-b border-white/10">
          ...
          {showLabels && (
            ...
            >
              ...
              <p className="text-brand-400 text-xs mt-0.5">System Admin</p>
            </motion.div>
          )}
        </div>
        ...
        <nav className="flex-1 py-6 space-y-1 px-3 overflow-y-auto">
          {ADMIN_NAV.map(({ to, label, icon: Icon }) => (
            <NavLink
              ...
              to={to}
              className={({ isActive }) =>
                `group flex items-center gap-3.5 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150
                ${isActive
        ...
        <div className="p-4 border-t border-white/10 hidden md:block">
          <button
            ...
            className="w-full flex items-center justify-center p-2.5 rounded-xl
                       hover:bg-white/10 text-brand-200 hover:text-white transition-all duration-200"
          >
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="text-left hidden sm:block">
                  ...
                  <p className="text-xs text-brand-500/70">System Admin</p>
                </div>
              ...
              <AnimatePresence>
                {userMenuOpen && (
                  <motion.div
                    ...
                    className="absolute right-0 top-full mt-2 bg-white rounded-xl shadow-lg
                               border border-brand-100 w-52 z-50 overflow-hidden"
                  >
